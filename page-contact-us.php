...
$address = get_theme_mod('petyar_contact_address', 'مشهد، هاشمیه');
$email = get_theme_mod('petyar_contact_email', 'petyarscontact@gmail.com');
$phone = get_theme_mod('petyar_contact_phone', '09035686351');
?>
