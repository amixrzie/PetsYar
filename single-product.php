                                        ...
                                        <div class="card-body mb-3 text-center">
                                            <a href="<?php the_permalink(); ?>">
                                                ...
                                                if (has_post_thumbnail()) {
                                                    ...
                                                    echo '<img class="img-fluid" src="' . esc_url(get_template_directory_uri() . '/assets/img/no-image.png') . '" alt="no image">';
                                                }
                                                ?>
                                            </a>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-2">
                                                <a href="<?php echo esc_url(add_query_arg('add-to-cart', get_the_ID())); ?>"
                                                   class="add-to-cart hoverable outlined">
                                                    <span><?php esc_html_e('افزودن به سبد خرید', 'petyar'); ?></span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-5 col-sm-6 d-flex align-items-center pic-product">
                                <div class="white-box text-center">
                                    ...
                                    if (has_post_thumbnail()) {
                                        ...
                                        echo '<img src="' . esc_url(get_template_directory_uri() . '/assets/img/no-image.png') . '" class="img-responsive" alt="' . esc_attr(get_the_title()) . '">';
                                    }
                                    ?>
                                </div>
                            </div>
