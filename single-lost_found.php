<?php
/**
 * Template for single Lost/Found ads (CPT: lost_found)
 * Place this file in your theme root as single-lost_found.php
 */
...
<section class="container">
  <div class="row">
    ...
    <!-- Sidebar: دسته‌بندی بر اساس taxonomy نوع حیوان -->
    <div class="col-xl-3 order-xl-1 pt-3 order-1 mb-3">
      ...
      <div class="card side-category p-4 mb-3">
        <ul class="list-unstyled">
          <?php
          // نمایش ترم‌های LF Species برای این آگهی
          $species_terms = get_the_terms( get_the_ID(), 'lf_species' );
          if ( $species_terms && ! is_wp_error( $species_terms ) ) :
            ...
            <li><?php esc_html_e( 'بدون دسته‌بندی', 'petyar' ); ?></li>
          <?php endif; ?>
        </ul>
      </div>
    </div>
      ...
      <?php while ( have_posts() ) : the_post(); ?>
        ...
        <div class="mb-3 p-3">
          <div class="op p_relative">
            <?php
              if ( has_post_thumbnail() ) {
                the_post_thumbnail( 'full', [
                  'class' => 'img-fluid mb-4 blogimg radius30',
                  'alt'   => get_the_title(),
                ] );
              }
            ?>
            ...
            <a class="op-link" href="<?php the_permalink(); ?>"></a>
          </div>
        </div>
