<footer class="footer-parent pt-4 pb-4">
    <div class="container footer-wrap">
                    ...
                    <div class="d-flex align-items-center my-3">
                        <svg width="22" height="26" viewbox="0 0 22 26" fill="none"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  ...
                                  stroke="#4e62af" stroke-width="1.5" stroke-linecap="round"
                        ...
                        <p class="mr-2">
                            آدرس : <?php echo get_theme_mod('petsyar_address', 'مشهد,هاشمیه'); ?>
                        </p>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex align-items-center my-3">
                            <svg width="22" height="21" viewbox="0 0 22 21" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.353 1C17.054 1.411 19.978 4.331 20.393 8.032" stroke="#4e62af"
                            ...
                            <p class="mr-2">
                                <?php echo get_theme_mod('petsyar_phone', '09035686251'); ?>
                            </p>
                        </div>
                        <div class="d-flex align-items-center my-3">
                            <svg width="22" height="20" viewbox="0 0 22 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.9026 6.8512L12.4593 10.4642C11.6198 11.1302 10.4387 11.1302 9.59919 10.4642L5.11841 6.8512"
                                      stroke="#4e62af" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="mb-2 text-right">
                    <div class="bg-clock p-4 radius30">
                        <div class="clock-pet px-3 py-2">
                            <p>شنبه - چهارشنبه:</p>
                            <p><?php echo get_theme_mod('petsyar_work_sat_wed', '8:00 - 15:00'); ?></p>
                        </div>
                        <div class="clock-pet px-3 py-2">
                            <p>پنجشنبه:</p>
                            <p><?php echo get_theme_mod('petsyar_work_thu', '8:00 - 12:00'); ?></p>
                        </div>
                        <div class="clock-pet px-3 py-2">
                            <p>جمعه:</p>
                            <p><?php echo get_theme_mod('petsyar_work_fri', 'تعطیل'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex align-items-center justify-content-between copyright py-3 px-5 radius30">
            ...
            <div>
                <p class="text-center fa14">
                    <?php echo get_theme_mod('petsyar_copyright', 'کلیه حقوق مادی و معنوی این قالب برای توسعه دهندگان آن محفوظ است.'); ?>
                </p>
            </div>

            <div class="text-left logo-footer">
                <img src="<?php echo get_template_directory_uri(); ?>" alt="footer logo">
            </div>
        </div>
    </div>
</footer>
