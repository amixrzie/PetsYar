                      ...
                      <span class="input-group-btn">
                        <button type="button" class="quantity-left-minus btn p-3"
                          ...
                          <svg width="16" height="18" viewBox="0 0 16 18" fill="none"
                            ...
                            <path d="M14.8692 4.74121H1.36621" stroke="#4e62af" stroke-width="2" stroke-linecap="round"
                        ...
                        <button type="button" class="quantity-right-plus btn p-3"
                          ...
                          <svg width="15" height="16" viewBox="0 0 15 16" fill="none"
                               xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.41602 1.71582V13.8158" stroke="#4e62af" stroke-width="2.5"
                                  stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M13.599 7.76782H1.25195" stroke="#4e62af" stroke-width="2.5" stroke-linecap="round"
                                  stroke-linejoin="round"/>
                          </svg>
                        </button>
                      </span>
