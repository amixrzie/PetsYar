    ...
    <section class="container mb-4">
        <div class="row">
            ...
            <div class="col-xl-3 order-xl-1 pt-3 order-1 mb-3">
                ...
                <?php
                $term_slug = isset($_GET['cat']) ? sanitize_text_field($_GET['cat']) : '';
                $args = [
                ...
                <div class="card side-category p-4 mb-3">
                    <ul class="list-unstyled">
                        ...
                        $base_url = get_permalink(get_page_by_path('page-lost_found'));

                        foreach ($species_terms as $term) :
                            $term_url = add_query_arg('cat', $term->slug, $base_url);
                            ?>
                            <li>
