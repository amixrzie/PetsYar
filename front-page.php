 ...
 * این فایل صفحه‌ی اصلی قالب «پت یار» است.
 */
...
jQuery(document).ready(function($){
    ...
    <div class="container p-0 my-2">
        <div class="row">
            <?php
            // ترم‌های product_category با این اسلاگ‌ها را از پیش بساز:
            $categories = [
                'food'        => 'Asset2501.png',   // غذا و انواع کنسرو
                'accessories' => 'Asset2500.png',   // لباس و اکسسوری
                'equipment'   => 'Asset2502.png',   // تجهیزات و اسباب بازی
            ];
    ...
    <p class="mb-5">
        <?php _e('انواع محصولات باکیفیت برای پت های دوست داشتنی شما', 'petyar'); ?>
    </p>
        ...
        <div class="row">
            <div class="col-lg-7 pl-lg-5">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a
                            class="d-flex align-items-center a-button radius55 py-2 px-4"
                            href="<?php home_url('/about/'); ?>">
                        <span class="ml-2"><?php _e('بیشتر بخوانید', 'petyar'); ?></span>
